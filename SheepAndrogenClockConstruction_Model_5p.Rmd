...
ggsave("/Users/victoriasugrue/Dropbox (Otago 
       University)/00_ThesisWriting/Figures/age_distribution_clockSheep_5.png",
       age_dist_5, width=10, height = 8, dpi=1000)
```
...
ggsave("/Users/victoriasugrue/Dropbox 
       (Otago University)/00_ThesisWriting/Figures/MKLN1_meth_sheepear_5.png",
       MKLN1_sheep_5, width=10, height = 8, dpi=1000)
```
...
```{r}
MAE_model_5p <- as.data.frame(Metrics::mae(actual=fitted_5$YPMP, 
...
LOORamAndroClockMAE_5 <- as.data.frame(Metrics::mae(actual=fittedLOO_5$YPMP, 
...
ramfit5
ggsave("/Users/victoriasugrue/Dropbox (Otago University)/00_ThesisWriting/Figures/5errormodel_ramFit.png",
       ramfit5, width=7, height = 6, dpi=1000)
...
ewe_MAE_model_5p <- as.data.frame(Metrics::mae(actual=ewe_data_5$YPMP, 
...
wether_MAE_model_5p <- as.data.frame(Metrics::mae(actual=wether_data_5$YPMP, 
...
ewewether_5_violin <- ggplot(ewewether_5, aes(x=Castration_Sex, 
  ...
  theme(legend.position = "none") +
   labs(title = "Ewe and wether androgen clock fit (model_5p), 
        trained on all rams", subtitle = "Ewe MAE=0.389, Wether MAE=0.331") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(plot.subtitle = element_text(hjust = 0.5))
...
ggsave("/Users/victoriasugrue/Dropbox (Otago 
    University)/00_ThesisWriting/Figures/5errormodel_ewewetherFit_violin.png",
       ewewether_5_violin, width=11, height = 6, dpi=1000)
