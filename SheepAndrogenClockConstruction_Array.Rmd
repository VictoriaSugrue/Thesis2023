...
ramfit_array <- ggplot(fitted_array, aes(x=YPMP, y=Fit_AndroAge)) +
  ...
  labs(title = "Array; Trained and tested on all",
              subtitle = "MAE=0.496, cor=0.911") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(plot.subtitle = element_text(hjust = 0.5))
ramfit_array
ggsave("/Users/victoriasugrue/Dropbox (Otago University)/00_ThesisWriting/Figures/arraymodel_ramFit.png",ramfit_array, width=8, height = 7, dpi=1000)
